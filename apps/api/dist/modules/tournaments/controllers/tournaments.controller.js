...
let TournamentsController = class TournamentsController {
    ...
    async createTournament(facilityId, userId, createTournamentDto) {
        return this.tournamentsService.createTournament(facilityId, userId, createTournamentDto);
    }
    async getTournament(tournamentId) {
        return this.tournamentsService.getTournament(tournamentId);
    }
    async updateTournament(tournamentId, facilityId, userId, updateTournamentDto) {
        return this.tournamentsService.updateTournament(tournamentId, facilityId, userId, updateTournamentDto);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String, tournament_dto_1.CreateTournamentDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, tournament_dto_1.UpdateTournamentDto]),
    __metadata("design:returntype", Promise)
], TournamentsController.prototype, "updateTournament", null);
__decorate([
